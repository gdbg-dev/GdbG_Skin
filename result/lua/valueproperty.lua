...
module.value = {
  ...
  {id = "ir_rank", src = "parts", x = 816, y = 98, w = 176, h = 19, divx = 11, digit = 4, zeropadding = 4, ref = 151},
  {id = "ir_total", src = "parts", x = 816, y = 98, w = 176, h = 19, divx = 11, digit = 4, zeropadding = 4, ref = 151},
