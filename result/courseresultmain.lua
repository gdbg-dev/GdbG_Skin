...
local function main()
	...
	skin.font = {"../fonts/RobotoMono-Medium.ttf"}
	...
	for i = 0, 4 do
		...
		table.insert(skin.destination, {id = "jgf", op = {920},	loop = 200, dst = {{time = 0, x = playInfoX + 363, y = judgeY + 288 - 48 * i, w = 32, h = 37, a = 0},
		{time = 200, a = 255}}})
		table.insert(skin.destination, {id = "jgs", op = {920},	loop = 200, dst = {{time = 0, x = playInfoX + 363, y = judgeY + 288 - 48 * i, w = 32, h = 37, a = 0},
		{time = 200, a = 255}}})
