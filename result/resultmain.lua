...
local function main()
		...
		table.insert(skin.destination,
			{
				...
				loop = 200,
				op = { 320 + 1 * i },
				dst = { { time = 0, x = clearX + 10, y = clearY + 170, w = 101, h = 38, a = 0 },
					{ time = 200, a = 255 } }
			})             --current
		table.insert(skin.destination,
			{
				...
				loop = 200,
				op = { 300 + 1 * i },
				dst = { { time = 0, x = clearX + 190, y = clearY + 170, w = 101, h = 38, a = 0 },
					{ time = 200, a = 255 } }
			})             --best
		table.insert(skin.destination,
			{
				...
				loop = 200,
				op = { 300 + 1 * i },
				dst = { { time = 0, x = clearX + 1000, y = clearY + 300, w = 415, h = 178, a = 0 },
					{ time = 200, a = 255 } }
			})             --big
	end
		...
		table.insert(skin.destination,
			{
				id = "jg" .. i,
				loop = 200,
				dst = { { time = 0, x = 1060, y = 338 - 51 * i, w = 32, h = 37, a = 0 },
					{ time = 200, a = 255 } }
			})
	end
	table.insert(skin.destination, {
		id = "miss",
		loop = 200,
		dst = { { time = 0, x = 1060, y = 90, w = 32, h = 37, a = 0 },
			{ time = 200, a = 255 } }
	})
	...
	for i = 0, 4 do
		table.insert(skin.destination,
			{ id = "judge" .. i, filter = 1, op = { 180 + 1 * i }, dst = { { x = songX + 330, y = songInfoY + 600, w = 280, h = 24, r = 221, g = 229, b = 237 } } })
	end
