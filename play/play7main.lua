...
local category = {
	{ name = "メイン", item = { "main_1", "main_2", "main_5", "main_6" } }, {
	name = "プレイ",
	item = {
		"play_1", "play_2", "play_3", "play_4", "play_16", "play_17",
		"play_5", "play_6", "play_18", "play_19", "play_7", "play_15",
		"play_8", "play_10", "play_11", "play_12", "play_13", "play_14"
	}
}
...
local property = {
	{
		name = "スクラッチノーツ",
		category = "main_1",
		item = { { name = "左", op = 900 }, { name = "右", op = 901 } }
	}, {
	name = "プレイエリア",
	category = "main_2",
	item = {
		{ name = "1P側(左)", op = 902 }, { name = "2P側(右)", op = 906 }
	}
}, {
	name = "スクラッチキービーム",
	category = "play_15",
...
local function is2P() return skin_config.option["プレイエリア"] == 906 end
...
local function isTargetBest()
	return
		skin_config.option["ターゲット"] == 913
end

local function isKeybeamKB()
	return skin_config.option["スクラッチキービーム"] == 923
end
local function isFastSlowOn() return skin_config.option["Fast/Slow"] == 916 end
local function isFastSlowMS() return skin_config.option["Fast/Slow"] == 926 end

local filepath = {
	{ name = "ノーツ", category = "play_1", path = "parts/notes/*.png" }, {
	name = "判定",
	category = "play_2",
	path = "parts/judge/*.png",
	def = "_default2"
}, {
	name = "キービーム",
	category = "play_7",
	path = "parts/keybeam/*.png",
	def = "medium"
}, {
	name = "ボム",
	category = "play_8",
	...
	name = "レーンカバー",
	category = "play_11",
	path = "parts/lanecover/*.png",
	def = "_default"
}, {
	name = "リフトカバー",
	category = "play_12",
	path = "parts/liftcover/*.png",
	def = "_default"
}, {
	name = "HIDDEN用カバー",
	category = "play_13",
	path = "parts/hiddencover/*.png",
	def = "_black"
}
...
local function main()
	...
	if isScratchRight() then geometry.lane_line_src = 950 end
	...
	skin.image = {
		...
		y = notesInfo.lnAc_y,
		w = notesInfo.Bl_width,
		h = notesInfo.height * 2,
		divy = 2,
		cycle = notesInfo.lnCycle
	}, {
		id = "lnBo-Wh",
		src = "notes_src",
		x = notesInfo.Wh_x,
		...
		h = notesInfo.height,
		divy = 2,
		cycle = notesInfo.hcnDamageCycle
	}, {
		id = "hcRe-Wh",
		src = "notes_src",
		x = notesInfo.Wh_x,
	...
	skin.hiddenCover = {
		{
			...
			w = 513,
			h = 853,
			disapearLine = geometry.lane_y + 3
		}
	...
	skin.note = {
		id = "notes",
		note = {
			"note-Wh", "note-Bl", "note-Wh", "note-Ye", "note-Wh", "note-Bl",
			"note-Wh", "note-Sc"
		},
		lnend = {
			"lnEn-Wh", "lnEn-Bl", "lnEn-Wh", "lnEn-Ye", "lnEn-Wh", "lnEn-Bl",
			"lnEn-Wh", "lnEn-Sc"
		},
		lnstart = {
			"lnSt-Wh", "lnSt-Bl", "lnSt-Wh", "lnSt-Ye", "lnSt-Wh", "lnSt-Bl",
			"lnSt-Wh", "lnSt-Sc"
		},
		lnbody = {
			"lnBo-Wh", "lnBo-Bl", "lnBo-Wh", "lnBo-Ye", "lnBo-Wh", "lnBo-Bl",
			"lnBo-Wh", "lnBo-Sc"
		},
		lnactive = {
			"lnAc-Wh", "lnAc-Bl", "lnAc-Wh", "lnAc-Ye", "lnAc-Wh", "lnAc-Bl",
			"lnAc-Wh", "lnAc-Sc"
		},
		hcnend = {
			"hcEn-Wh", "hcEn-Bl", "hcEn-Wh", "hcEn-Ye", "hcEn-Wh", "hcEn-Bl",
			"hcEn-Wh", "hcEn-Sc"
		},
		hcnstart = {
			"hcSt-Wh", "hcSt-Bl", "hcSt-Wh", "hcSt-Ye", "hcSt-Wh", "hcSt-Bl",
			"hcSt-Wh", "hcSt-Sc"
		},
		hcnbody = {
			"hcBo-Wh", "hcBo-Bl", "hcBo-Wh", "hcBo-Ye", "hcBo-Wh", "hcBo-Bl",
			"hcBo-Wh", "hcBo-Sc"
		},
		hcnactive = {
			"hcAc-Wh", "hcAc-Bl", "hcAc-Wh", "hcAc-Ye", "hcAc-Wh", "hcAc-Bl",
			"hcAc-Wh", "hcAc-Sc"
		},
		hcndamage = {
			"hcDm-Wh", "hcDm-Bl", "hcDm-Wh", "hcDm-Ye", "hcDm-Wh", "hcDm-Bl",
			"hcDm-Wh", "hcDm-Sc"
		},
		hcnreactive = {
			"hcRe-Wh", "hcRe-Bl", "hcRe-Wh", "hcRe-Ye", "hcRe-Wh", "hcRe-Bl",
			"hcRe-Wh", "hcRe-Sc"
		},
		mine = {
			"mine-Wh", "mine-Bl", "mine-Wh", "mine-Bl", "mine-Wh", "mine-Bl",
			"mine-Wh", "mine-Sc"
		},
		hidden = {},
		processed = {},
		group = {
			{
				...
				dst = {
					{
						x = geometry.lane_x + geometry.lane_line_width +
							geometry.play_position,
						y = geometry.lane_y,
						w = geometry.lane_w - (geometry.lane_line_width * 2),
						h = 3,
						r = 128,
						g = 128,
						b = 128
	...
	if isScratchRight() then
		...
		geometry.notes_x[8] = geometry.lane_x + geometry.lane_w -
			geometry.lane_line_width - geometry.notes_w[8]
	else
		geometry.notes_x[8] = geometry.lane_x + geometry.lane_line_width
		geometry.notes_x[1] = geometry.notes_x[8] + geometry.notes_w[8] +
			geometry.lane_line_width
	end

	for i = 2, 7 do
		if i % 2 == 0 then
			geometry.notes_x[i] = geometry.notes_x[i - 1] + notesInfo.Wh_width +
				geometry.lane_line_width
			geometry.notes_w[i] = notesInfo.Bl_width
		else
			geometry.notes_x[i] = geometry.notes_x[i - 1] + notesInfo.Bl_width +
				geometry.lane_line_width
	...
	skin.gauge = {
		...
		nodes = {
			...
			-- アシストイージーゲージ
			"gauge-r1", "gauge-p1", "gauge-r2", "gauge-p2", "gauge-r3",
			"gauge-p3", -- イージーゲージ
			"gauge-r1", "gauge-g1", "gauge-r2", "gauge-g2", "gauge-r3",
			"gauge-g3", -- ノーマルゲージ
			"gauge-r1", "gauge-b1", "gauge-r2", "gauge-b2", "gauge-r3",
			"gauge-b3", -- ハードゲージ(2,4,6番目はダミー？)
			"gauge-r1", "gauge-p1", "gauge-r2", "gauge-p2", "gauge-r3",
			"gauge-p3", -- EXハードゲージ(2,4,6番目はダミー？)
			"gauge-y1", "gauge-p1", "gauge-y2", "gauge-p2", "gauge-y3",
			"gauge-p3", -- ハザードゲージ(2,4,6番目はダミー？)
			"gauge-w1", "gauge-w1", "gauge-w2", "gauge-w2", "gauge-w3",
			"gauge-w3"
		}
	}
	skin.judge = {
			...
			images = {
				{
					...
					dst = {
						{
							time = 0,
							x = geometry.lane_x + geometry.judge_x +
								geometry.play_position,
							y = geometry.judge_y,
							w = 191,
							h = 61
				...
				dst = {
					{
						time = 0,
						x = 40 + geometry.lane_x + geometry.judge_x +
							geometry.play_position,
						y = geometry.judge_y,
						w = 191,
						h = 61
				...
				dst = {
					{
						time = 0,
						x = 50 + geometry.lane_x + geometry.judge_x +
							geometry.play_position,
						y = geometry.judge_y,
						w = 191,
						h = 61
			...
			numbers = {
				{
					...
					offsets = { 32 },
					dst = {
						{ time = 0, x = 224, y = 0, w = 50, h = 70 }, { time = 500 }
					}
				}, {
				id = "judge-num-gr",
				loop = -1,
	...
	if is2P() then
		table.insert(skin.destination, {
			id = "title",
			filter = 1,
			dst = { { x = 400, y = 970, w = 575, h = 30 } }
		})
		table.insert(skin.destination, {
			id = "tablename",
			filter = 1,
			dst = { { x = 400, y = 1050, w = 575, h = 26 } }
		})
	else
		table.insert(skin.destination, {
			id = "title",
			filter = 1,
			dst = { { x = 1180, y = 970, w = 575, h = 30 } }
		})
		table.insert(skin.destination, {
			id = "tablename",
			filter = 1,
			dst = { { x = 1230, y = 1050, w = 575, h = 26 } }
		})
	end
	...
	table.insert(skin.destination, {
		id = "notes-head",
		dst = { { x = 585 + geometry.score_position, y = 300, w = 95, h = 21 } }
	})
	table.insert(skin.destination, {
		id = "note",
		dst = { { x = 790 + geometry.score_position, y = 280, w = 14, h = 18 } }
	})
	...
	if is2P() then
		table.insert(skin.destination, {
			...
			dst = { { x = 1870, y = 0, w = 70, h = 1080 } }
		})
		table.insert(skin.destination, {
			id = "song-progress",
			dst = { { x = 1883, y = 1007, w = 18, h = 30 } }
		})
	else
		table.insert(skin.destination, {
			id = "song-progress-bar",
			dst = { { x = 0 - geometry.info_position, y = 0, w = 70, h = 1080 } }
		})
		table.insert(skin.destination, {
			id = "song-progress",
			dst = { { x = 13 - geometry.info_position, y = 1007, w = 18, h = 30 } }
		})
	end
	...
	table.insert(skin.destination, {
		id = "BPM-head",
		dst = { { x = 52 + geometry.info_position, y = 255, w = 250, h = 60 } }
	})

	-- 枠
	table.insert(skin.destination, {
		id = "BPM-bar",
		dst = { { x = 875 - geometry.info_position, y = 80, w = 1000, h = 34 } }
	})
	-- 今のBPM
	table.insert(skin.destination, {
		id = "BPM-now",
	...
	table.insert(skin.destination, {
		id = "BPM-min",
		op = { 177 },
		dst = { { x = 1270 - geometry.info_position, y = 125, w = 14, h = 18 } }
	})
	-- BPM変わらない曲のとき
	table.insert(skin.destination, {
		id = "BPM-no-change",
	...
	table.insert(skin.destination, {
		id = "BPM-no-change",
		op = { 176 },
		dst = { { x = 1270 - geometry.info_position, y = 125, w = 60, h = 21 } }
	})
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				time = 0,
				x = geometry.lane_x + geometry.play_position,
				y = 1080,
				w = geometry.lane_w,
				h = geometry.lane_h,
				acc = 2
			}, { time = 200 }, { time = 800, y = geometry.lane_y }
		}
	})
	-- レーン線
	table.insert(skin.destination, {
		...
		dst = {
			{
				time = 0,
				x = 3 + geometry.lane_x + geometry.play_position,
				y = 1080,
				w = geometry.lane_w - 6,
				h = geometry.lane_h - 3,
				acc = 2
			}, { time = 500 }, { time = 1300, y = 3 + geometry.lane_y }
		}
	})
	table.insert(skin.destination, {
		id = -111,
		...
		dst = {
			{
				...
				b = 0,
				acc = 2
			}, { time = 1400 }, { time = 1700, w = geometry.lane_w - 6 }
		}
	})
	-- 下のボタン
	if isScratchRight() then
			...
			dst = {
				{
					...
					h = 100,
					acc = 2
				}, { time = 200 }, { time = 800, y = -100 + geometry.lane_y }
			}
		})
	else
		table.insert(skin.destination, {
	...
	do
		for i = 1, 7, 1 do
			table.insert(skin.destination, {
				id = "keybeam-" .. kb_type[i],
				offset = 3,
				timer = kb_onTimer[i],
				blend = 1,
				dst = {
					{
						x = geometry.play_position + kb_x[i],
						y = geometry.lane_y + geometry.lane_line_width,
						w = kb_w[i],
						h = geometry.lane_h
					}
		...
		for i = 1, 7, 1 do
			table.insert(skin.destination, {
				...
				dst = {
					...
					{
						time = 80,
						x = geometry.play_position + kb_x[i] + kb_move_x[i],
						w = 0,
						a = 0
					}
				}
	...
	if isKeybeamKB() then
		table.insert(skin.destination, {
			id = "keybeam-" .. kb_type[8],
			offset = 3,
			timer = kb_onTimer[8],
			blend = 1,
			dst = {
				{
					x = geometry.play_position + kb_x[8],
					y = geometry.lane_y + geometry.lane_line_width,
					w = kb_w[8],
					h = geometry.lane_h
				}
		...
		table.insert(skin.destination, {
			...
			dst = {
				...
				{
					time = 80,
					x = geometry.play_position + kb_x[8] + kb_move_x[8],
					w = 0,
					a = 0
				}
			}
		...
		dst = {
			{
				...
				x = geometry.lane_x + geometry.lane_line_width +
					geometry.play_position,
				y = (geometry.lane_y + 3) - geometry.lane_h,
				w = geometry.lane_w - (geometry.lane_line_width * 2),
				h = geometry.lane_h,
				a = 0
			}, { time = 1700 }, { time = 2000, a = 255 }
		}
	})
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				time = 0,
				x = geometry.lane_x + geometry.lane_line_width + sp5_x +
					geometry.play_position,
				y = geometry.lane_y + 3,
				w = 114,
				h = geometry.lane_h - 3,
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				x = 78 + geometry.lane_x + geometry.lane_line_width +
					geometry.play_position,
				y = 1095,
				w = 6,
				h = 14,
				a = 0
			}, { time = 1300, a = 0 }, { time = 1400, a = 255 }
		}
	})
	table.insert(skin.destination, {
		id = "lanecover-value",
		...
		dst = {
			{
				x = 90 + geometry.lane_x + geometry.lane_line_width +
					geometry.play_position,
				y = 1095,
				w = 15,
				h = 18,
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				x = 228 + geometry.lane_x + geometry.lane_line_width +
					geometry.play_position,
				y = 1095,
				w = 6,
				h = 14,
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				x = 240 + geometry.lane_x + geometry.lane_line_width +
					geometry.play_position,
				y = 1095,
				w = 15,
				h = 18,
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				x = 378 + geometry.lane_x + geometry.lane_line_width +
					geometry.play_position,
				y = 1095,
				w = 6,
				h = 14,
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				x = 390 + geometry.lane_x + geometry.lane_line_width +
					geometry.play_position,
				y = 1095,
				w = 15,
				h = 18,
	...
	if isFastSlowOn() then
		table.insert(skin.destination, {
			...
			dst = {
				{
					time = 0,
					x = geometry.lane_x + geometry.judge_x + 40 +
						geometry.play_position,
					y = geometry.judge_y + 90 + 5,
					w = 144,
					h = 40
				}, { time = 500 }
			}
	...
	elseif isFastSlowMS() then
		table.insert(skin.destination, {
			...
			dst = {
				{
					time = 0,
					x = geometry.lane_x + geometry.judge_x + 6 +
						geometry.play_position,
					y = geometry.judge_y + 90 + 5,
					w = 144,
					h = 40
		...
		if isTargetBest() then
			table.insert(skin.destination, {
				...
				dst = {
					{
						time = 0,
						x = 120 + geometry.lane_x + geometry.judge_x +
							geometry.play_position,
						y = geometry.judge_y + 90 + 5,
						w = 20,
						h = 20
	...
	-- ボム先読み
	table.insert(skin.destination,
		{ id = "bomb", dst = { { x = 0, y = 0, w = 1, h = 1 } } })
	table.insert(skin.destination,
		{ id = "lnbomb", dst = { { x = 0, y = 0, w = 1, h = 1 } } })
	-- 爆発エフェクト
	-- 通常爆発エフェクトの配置
	...
	for i = 1, #b_init, 1 do
		table.insert(skin.destination, {
			...
			dst = {
				{
					time = 0,
					x = geometry.play_position + geometry.lane_x +
						geometry.lane_line_width + bombPosX[i] - bombWidth / 2,
					y = geometry.lane_y + geometry.lane_line_width -
						(bombHeight / 2),
					w = bombWidth,
					h = bombHeight
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				time = 0,
				x = geometry.lane_x + geometry.lane_line_width + 74 +
					geometry.play_position,
				y = geometry.lane_y + 300,
				w = 439,
				h = 60,
				a = 0
			}, { time = 500 }, { time = 750, a = 255 }
		}
	})
	table.insert(skin.destination, {
		id = "fc_lamp",
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				time = 0,
				x = 196 + geometry.lane_x + geometry.play_position,
				y = geometry.lane_y + 50,
				w = 20,
				h = 40,
				a = 0
			}, { time = 250, a = 255 }
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				time = 0,
				x = 216 + geometry.lane_x + geometry.play_position,
				y = geometry.lane_y + 50,
				w = 130,
				h = 40
			}
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				time = 0,
				x = 143 + geometry.lane_x + geometry.play_position,
				y = geometry.lane_y + 40,
				w = 20,
				h = 50,
				a = 0
			}, { time = 1800 }, { time = 2050, a = 255 }
		}
	})
	table.insert(skin.destination, {
		id = "autoplay_tx",
		...
		dst = {
			{
				time = 0,
				x = 163 + geometry.lane_x + geometry.play_position,
				y = geometry.lane_y + 40,
				w = 250,
				h = 50,
				a = 0
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				time = 0,
				x = 171 + geometry.lane_x + geometry.play_position,
				y = geometry.lane_y + 40,
				w = 20,
				h = 50,
				a = 0
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				time = 0,
				x = 191 + geometry.lane_x + geometry.play_position,
				y = geometry.lane_y + 40,
				w = 160,
				h = 50,
				a = 0
	...
	if is2P() then -- 2P
		table.insert(skin.destination, {
			id = "gauge",
			dst = { { x = 1870, y = 120, w = -350, h = 34 } }
		})
	else -- 1P
		table.insert(skin.destination,
			{ id = "gauge", dst = { { x = 70, y = 120, w = 350, h = 34 } } })
	end
	...
	table.insert(skin.destination, {
		id = "playoption_frame",
		dst = { { x = 25 + geometry.play_position, y = -35, w = 750, h = 230 } }
	})
	...
	table.insert(skin.destination, {
		id = "score-head",
		dst = { { x = 583 + geometry.score_position, y = 370, w = 250, h = 170 } }
	})
	---開始前にスコアのダミー表示するやつ
	table.insert(skin.image, {
		id = "score_dummy",
		src = "system_src",
		x = 1500 + geometry.score_position,
		y = 1150,
		w = 393,
		h = 193
	})
	table.insert(skin.destination, {
		id = "score_dummy",
		draw = function()
			if (main_state.number(101) < 0) then return true end
		end,
		dst = {
			{
				x = 164 + geometry.score_position + geometry.score_position,
				y = 764,
				w = 393,
				h = 193
			}
	...
	table.insert(skin.destination, {
		id = "scoregraph-grid",
		dst = { { x = 578 + geometry.score_position, y = 840, w = 250, h = 230 } }
	})
	-- レート・小数点以下・ドット、パーセント
	table.insert(skin.destination, {
		id = "hispeed-num",
		dst = { { x = 450 + geometry.score_position, y = 30, w = 24, h = 22 } }
	})
	table.insert(skin.destination, {
		id = "rate-DnP1",
		dst = { { x = 475 + geometry.score_position, y = 15, w = 50, h = 50 } }
	})
	table.insert(skin.destination, {
		id = "hispeed-adot-num",
		dst = { { x = 485 + geometry.score_position, y = 30, w = 24, h = 22 } }
	})
	...
	table.insert(skin.destination, {
		id = "timehispeed",
		dst = { { x = 260 + geometry.score_position, y = 80, w = 340, h = 22 } }
	})
	if is2P() then -- 2P
		table.insert(skin.destination, {
			id = "Score-num",
	...
	table.insert(skin.destination, {
		id = "rate-num",
		dst = { { x = 715 + geometry.score_position, y = 480, w = 18, h = 24 } }
	})
	table.insert(skin.destination, {
		id = "rate-adot-num",
		dst = { { x = 780 + geometry.score_position, y = 480, w = 18, h = 24 } }
	})
	table.insert(skin.destination, {
		id = "rate-DnP1",
		draw = function()
		...
		dst = { { x = 773 + geometry.score_position, y = 465, w = 50, h = 50 } }
	})
	table.insert(skin.destination, {
		id = "rate-DnP2",
		draw = function()
		...
		dst = { { x = 780 + geometry.score_position, y = 480, w = 94, h = 37 } }
	})
	...
	table.insert(skin.destination, {
		id = "score-best-dif",
		draw = function()
			if (main_state.float_number(113) ~= 0) then return true end
		end,
		dst = { { x = 736 + geometry.score_position, y = 450, w = 18, h = 24 } }
	})
	-- 自己ベストの点数
	table.insert(skin.destination, {
		id = "score-best",
		...
		dst = { { x = 756 + geometry.score_position, y = 420, w = 18, h = 24 } }
	})
	...
	table.insert(skin.destination, {
		id = "graph-best-now",
		dst = { { x = 686 + geometry.score_position, y = 550, w = 68, h = 500 } }
	})
	-- 自己ベスト　最終
	table.insert(skin.destination, {
		id = "graph-best",
	...
	do
		local id = {
			"tg-Am", "tg-A", "tg-Ap", "tg-AAm", "tg-AA", "tg-AAp", "tg-AAA-",
			"tg-AAA", "tg-AAAp", "tg-max", "tg-next"
		}
	...
	if is2P() then
		...
		table.insert(skin.destination, {
			id = "targetname",
			dst = { { x = 840 + geometry.score_position, y = 555, w = 75, h = 22 } }
		})
	end
	-- ターゲットとの差
	table.insert(skin.destination, {
		id = "score-targ-dif",
		dst = { { x = 735 + geometry.score_position, y = 380, w = 18, h = 24 } }
	})
	-- 自己ベストの点数
	table.insert(skin.destination, {
		id = "score-targ",
		dst = { { x = 753 + geometry.score_position, y = 350, w = 18, h = 24 } }
	})
	...
	do
		local id = {
			"judge-dt-pf", "judge-dt-gr", "judge-dt-gd", "judge-dt-bd",
			"judge-dt-pr", "judge-dt-ms", "judge-dt-br", "judge-dt-fa",
			"judge-dt-sl"
		}
		for i in ipairs(id) do
			table.insert(skin.image, {
	...
	do
		local id = {
			"lamp-judge-dt-pf", "lamp-judge-dt-gr", "lamp-judge-dt-gd",
			"lamp-judge-dt-bd", "lamp-judge-dt-pr", "lamp-judge-dt-ms",
			"lamp-judge-dt-br", "lamp-judge-dt-fa", "lamp-judge-dt-sl"
		}
		for i in ipairs(id) do
			table.insert(skin.image, {
				id = id[i],
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				time = 0,
				x = 248 + geometry.score_position + geometry.score_position,
				y = 358,
				w = 144,
				h = 40,
				a = 0
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				time = 0,
				x = 435 + geometry.score_position + geometry.score_position,
				y = 358,
				w = 144,
				h = 40,
				a = 0
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				x = 196 + geometry.score_position + geometry.score_position,
				y = 260,
				w = 144,
				h = 40,
				a = 0
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				x = 332 + geometry.score_position + geometry.score_position,
				y = 260,
				w = 144,
				h = 40,
				a = 0
	...
	table.insert(skin.destination, {
		...
		dst = {
			{
				x = 467 + geometry.score_position + geometry.score_position,
				y = 260,
				w = 144,
				h = 40,
				a = 0
	...
	table.insert(skin.destination, {
		id = "num-dt-fa",
		dst = { { x = 780 + geometry.score_position, y = 90, w = 20, h = 20 } }
	})
	table.insert(skin.destination, {
		id = "num-dt-sl",
		dst = { { x = 780 + geometry.score_position, y = 30, w = 20, h = 20 } }
	})
	-- 	--タイミングビジュアライザー
	-- 	table.insert(skin.destination,
	-- 	{id = "timing", dst = {
	...
	table.insert(skin.destination, {
		...
		op = { 80 },
		dst = {
			{ time = 0,   x = 0,  y = 360, w = 1920, h = 360, a = 0 }, { time = 300 },
			{ time = 600, a = 150 }
		}
	})
	-- ロード終了
	...
	table.insert(skin.destination, {
		...
		filter = 1,
		dst = {
			{ time = 0,   x = 445, y = 608, w = 1405, h = 27, a = 0 }, { time = 300 },
			{ time = 600, a = 255 }
		}
	})
	table.insert(skin.destination, {
		...
		filter = 1,
		dst = {
			{ time = 0,   x = 445, y = 520, w = 1405, h = 73, a = 0 }, { time = 300 },
			{ time = 600, a = 255 }
		}
	})
	table.insert(skin.destination, {
		...
		filter = 1,
		dst = {
			{ time = 0,   x = 445, y = 425, w = 1405, h = 41, a = 0 }, { time = 300 },
			{ time = 600, a = 255 }
		}
	})
	-- ロード終了
	...
	table.insert(skin.destination, {
		...
		op = { 80, 191 },
		dst = {
			{ time = 0,   x = 50, y = 420, w = 320, h = 240, a = 0 }, { time = 300 },
			{ time = 600, a = 255 }
		}
	})
	-- ロード終了
	...
	table.insert(skin.destination, {
		...
		dst = {
			...
			{ time = 300, w = 0 }, { time = 400 }, { time = 900, w = 1450 }
		}
	})
	table.insert(skin.destination, {
		id = "load-progress",
	...
	do
		local id = {
			"load-unknown", "load-beginner", "load-normal", "load-hyper",
			"load-another", "load-insane"
		}
		for i in ipairs(id) do
			table.insert(skin.image, {
				id = id[i],
	...
	table.insert(skin.destination, {
		...
		loop = 500,
		dst = {
			{ time = 0,   x = 0, y = 1080, w = 1920, h = 1080 }, { time = 50 },
			{ time = 500, y = 0 }
		}
	})
	table.insert(skin.destination, {
		...
		loop = 6000,
		dst = {
			{ time = 0,   x = 382, y = 480, w = 880, h = 240, a = 0 }, { time = 500 },
			{ time = 700, x = 460, a = 255 }, { time = 6000, a = 255, x = 660 }
		}
	})
